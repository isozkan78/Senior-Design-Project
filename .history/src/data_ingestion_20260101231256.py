...
# Note: Ensure you have authenticated using 'earthengine authenticate' in your terminal first.
try:
    ee.Initialize()
...
class DataIngestionPipeline:
    def __init__(self):
        ...
        # In a real scenario, we would upload a Shapefile for exact boundaries.
